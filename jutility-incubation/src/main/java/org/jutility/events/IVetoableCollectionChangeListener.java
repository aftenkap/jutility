...
public interface IVetoableCollectionChangeListener
     ...
     */
    void vetoableElementAdded(ICollectionChangeEvent event)
            throws CollectionChangeVetoException;
     ...
     *             if the change is to be rejected.
     */
    void vetoableElementRemoved(ICollectionChangeEvent event)
            throws CollectionChangeVetoException;
     ...
     *             if the change is to be rejected.
     */
    void vetoableCollectionCleared(ICollectionChangeEvent event)
            throws CollectionChangeVetoException;
}
