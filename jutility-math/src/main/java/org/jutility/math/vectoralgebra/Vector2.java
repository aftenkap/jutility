...
public class Vector2<T extends Number>
     ...
     */
    public static <T extends Number> IVector2<T> iUnitVector(Class<? extends T> type) {
     ...
     */
    public static <T extends Number> IVector2<T> jUnitVector(Class<? extends T> type) {
     ...
     */
    public static <T extends Number> IVector2<T> nullVector(Class<? extends T> type) {
     ...
     */
    public static <T extends Number> T dotProduct(IVector2<T> lhs,
            IVector2<T> rhs) {
     ...
     * @return the dot product.
     */
    public static <R extends Number> R dotProduct(IVector2<?> lhs,
     ...
     * provided {@link IVector2 Vector}.
     */
    public static <T extends Number> IVector2<T> perpendicularVector(
     ...
     * provided {@link IVector2 Vector}.
     */
    public static <R extends Number> IVector2<R> perpendicularVector(
